//
//  DesertsWithoutSugarCollectionViewCell.swift
//  FitnessApp
//
...
class DesertsWithoutSugarCollectionViewCell: UICollectionViewCell {
    static let identifier = "DesertsWithoutSugarCollectionViewCell"
    ...
    override init(frame: CGRect) {
        ...
        contentView.backgroundColor = UIColor.green.withAlphaComponent(0.4) // Adjust alpha as needed
