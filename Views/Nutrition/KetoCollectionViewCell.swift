...
class KetoCollectionViewCell: UICollectionViewCell {
    static let identifier = "KetoCollectionViewCell"
    ...
    override init(frame: CGRect) {
        ...
        contentView.backgroundColor = UIColor.systemPink.withAlphaComponent(0.4) // Adjust alpha as needed
