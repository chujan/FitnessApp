...
class FocusTableViewCell: UITableViewCell {
    static let identifier = "FocusTableViewCell"
    ...
    private let myImageView: UIImageView = {
        ...
        let heartImage = UIImage(systemName: "star")?.withTintColor(.white, renderingMode: .alwaysOriginal)
    ...
    func configure(image: UIImage?, calories: String) {
        myImageView.image = image ?? UIImage(systemName: "star")?.withTintColor(.white, renderingMode: .alwaysOriginal)
